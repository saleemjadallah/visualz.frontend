      ...
      <div className="space-y-1">
        ...
        <div className="relative">
          ...
          {isPassword && (
            ...
            >
              {showPassword ? <LineIcon name="eye-close" className="w-4 h-4" /> : <LineIcon name="eye" className="w-4 h-4" />}
            </button>
          )}
          
          {success && !error && (
            <div className="absolute right-3 top-1/2 transform -translate-y-1/2 text-green-500">
              <LineIcon name="checkmark" className="w-4 h-4" />
            </div>
          )}
          
          {error && (
            <div className="absolute right-3 top-1/2 transform -translate-y-1/2 text-red-500">
              <LineIcon name="cross-circle" className="w-4 h-4" />
            </div>
          )}
        </div>
  ...
  ({ onSearch, placeholder = 'Search...', className, ...props }, ref) => {
    ...
    return (
      <Input
        ...
        icon={<LineIcon name="search-alt" className="w-4 h-4" />}
